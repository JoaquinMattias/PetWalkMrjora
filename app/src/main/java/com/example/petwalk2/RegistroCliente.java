...
public class RegistroCliente extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1 = (Button) findViewById(R.id.btnsiguienteC);
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent sc = new Intent(RegistroCliente.this, RegistroPF.class);
                RegistroCliente.this.startActivity(sc);
            }
        });

        comuna= (Spinner) findViewById(R.id.spinnercliente);
        ciudad =(Spinner) findViewById(R.id.spinner2C);
